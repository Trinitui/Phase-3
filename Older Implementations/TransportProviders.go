...
func main() {
	fmt.Println("Starting Transport Trips MicroService!")
	...
	//db_connection := "user=postgres dbname=chicago_bi password=root host=host.docker.internal sslmode=disable"
